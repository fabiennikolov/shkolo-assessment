...
@section('content')
    ...
    <form action="{{ route('update-button', $button->id) }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <span class="absolute top-1/2 left-4 transform -translate-y-1/2 text-lg font-semibold text-gray-600">
                    <span class="block w-4 h-4 rounded-full"
                        style="background-color: {{ old('color', $button->color) }};"></span>
                </span>
            </div>
        ...
        <button type="submit"
            class="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-md transition duration-200 ease-in-out">
            Update Button
        </button>
    </form>
@endsection
